...
import { iliDataSetValues, SyndromicSpline, Status } from "../src/types/report";
...
function categoryBaselineMap() {
  ...
  return function getCategoryBaselineMod(
    ...
    // TODO: Add in percent of total ED visits
...
export function iliEpiAnalysis(
  ...
  return {
    data: dataWithDaysDecline.slice(-60).map(iliRemap),
...
function iliRemap(e: SyndromicDataWithDecline): SyndromicSpline {
