      ...
      <div className="c19-sr-criteria-graph-details">
        ...
        <ul className="c19-sr-criteria-graph-details__list">
          <li>
            ...
            chief complaint included coronavirus terms, their discharge
            diagnosis was related to coronavirus or severe acute respiratory
            syndrome, or both. The patient may or may not have taken a
            laboratory test.
          </li>
        </ul>
      </div>
